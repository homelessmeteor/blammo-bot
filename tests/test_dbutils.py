...
class TestDatabaseHealth(unittest.TestCase):
    ...
    def test_detect_merge_conflicts(self):
        ...
        test_content = """question,answer,qid
Normal question,Normal answer,123
<<<<<<< HEAD
Conflict question 1,Answer 1,124
=======
Conflict question 2,Answer 2,124
>>>>>>> branch
Another question,Another answer,125"""
